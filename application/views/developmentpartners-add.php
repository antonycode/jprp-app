...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Create Development Partner</li>
    </ol>
</section>
...
<section class="content">
    ...
    <form class="donor_form" id="Mechanism_details" action="<?php echo base_url('moh_manager/newdevp') ?>" method="post"
            ...
            <div class="col-md-6">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="firstname" id="firstname" placeholder="First Name" required pattern="[A-Za-z\s]{3,80}"/>
                        <span class="form_hint">First Name Must Be Of Atleast 3 Characters</span>
                    </li>
                    <li>
                        <label for="name">LastName:</label>
                        <input type="text" name="lastname" id="lastname" placeholder="Last Name" required pattern="[A-Za-z\s]{2,20}"/>
                        <span class="form_hint">Last Name Must Be Of Atleast 3 Characters</span>
                    </li>
                    ...
                    <section class="container">
                        ...
                        <div>
                            <div>
                                ...
                                <div>
                                    <select id="rightValues" size="10" name='programs[]'
                                            style="width:370px; height:250px;" multiple required>
                                    </select>
                                </div>
                            </div>
                        </div>
        ...
        $("#select").click(function () {
            ...
            $.each($("#rightValues option:selected"), function (id, name) {
                ...
                html += '<tr id="row_' + i + '"> <td> <input name="' + i + '_uuid" DISABLED value="' + name.value + '" style="width:7em"></td><td> <div style="width:200px">' + $(this).text() +
                    '</div></td><td>' + <?php if ($programs != '') {
                        echo '\'<select style="min-width:150px; max-width: 200px; height:30px;">';
                        foreach ($programs as $row) {
                            echo '<option value="' . $row->program_id . '">' . $row->program_name . '</option>';
                        }
                        echo '</select>\'';
