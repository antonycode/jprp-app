...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?>/style/images/favicon.ico" />
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>/style/error/favicon.ico" />
