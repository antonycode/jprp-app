...
<script>
    function mechanismsUpload(urls) {
        ...
        var r = $.ajax({
            ...
            dataType: 'json',
            async: false,
            url: "<?php echo base_url();?>ipsl/ipslexcelimport/?url=" + file,
            cache: false,
            beforeSend: function () {
                // alert(urls);
                $('#loadScreen').show();
...
<section class="content">
    ...
    <div class="row">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">IPSL Support Table</h3>
            ...
            <div id="btn-table" class="box-body table-responsive">
                <table id="mechanisms-table" class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th style="width:5%">#</th>
                    	<th style="width:25%">Organization Unit</th>
    ...
    <div class="row">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">IPSL Import Errors Table</h3>
            </div>
            <!-- /.box-header -->
            <div id="btn-table-error" class="box-body table-responsive">
                <table id="mechanisms-table" class="table table-bordered table-striped">
                    <tid="btn-table" head>
                    <tr>
                        <th style="width:5%">#</th>
...
<script type="text/javascript">
 ...
 //'colvis','copy'
    tablelist.buttons().container()
        ...
        var tableerror=$('#supporterrors-table').DataTable({
        "bPaginate": true,
        "bLengthChange": true,
        "bFilter": true,
        "bSort": true,
 ...
 //'colvis','copy'
    tableerror.buttons().container()
        .appendTo('#btn-table-error .col-sm-6:eq(0)');
