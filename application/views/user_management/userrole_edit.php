...
<section class="content">
    ...
    <form class="donor_form" id="userrole_details" action="<?php echo base_url('user_manager/update_userrole') ?>"
            ...
            <div class="col-md-5">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="hidden" name="roleid" value="<?php echo $role->attributionroleid; ?>">
                        <input type="text" name="role_name" id="userrole" value="<?php echo $role->rolename; ?>" placeholder="User role" required pattern="[A-Za-z\s0-9]{2,150}"/>
                                ...
                                <div>
                                    <select id="rightValues" size="10" name='authorities[]'
                                        ...
                                        if ($selected_authorities != '') {
                                            foreach ($selected_authorities as $row) {
                                                echo "<option value='$row->attributionauthoritiesid'>$row->attributionauthoritiesname</option>";
                                            }
                                        }
                                        ?>
