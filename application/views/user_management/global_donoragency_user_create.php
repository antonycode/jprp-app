        ...
        <div class="row">
            <form class="donor_form" id="program_details" action="<?php echo base_url('programmanager/addnewprogram')?>" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="firstname" id="username"  placeholder="Username"  required pattern="{2,}"  />
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                                ...
                                <select id="datasets" class="chosen-select" style="height: 30px;  " placeholder="User Organization" onchange="getElements()" tabindex="2">
                                ...
                                <span class="form_hint">Select User Oragnization</span>
                            </div>                            
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div>
                            <label for="User Roles" style="font-size: 16px; width: 200px"> User Roles JPRP</label>
                        </div>
                        ...
                        <section class="container">
                            ...
                            <div>
                                <div>
                                    <label for="name" style="font-size: 16px; width: 200px">User Roles Available </label>
                                </div>
                                <div>
                            ...
                            <div>
                                <div>
                                    <div>
                                        <label for="name" style="font-size: 16px; margin-left:0px; width: 200px">Selected User Roles</label>
                                    </div>
                                    <div>
                                        <select id="rightValues" size="10" name='jprproles[]' style="width:370px; height:250px;" multiple required >
                                        </select>
                                    </div>
                                </div>
                            </div>
