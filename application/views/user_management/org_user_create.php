        ...
        <div class="row">
            <form class="donor_form" id="program_details" action="<?php echo base_url('programmanager/addnewprogram')?>" method="post">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="form_hint">"Must contain at least one number and one uppercase and lowercase letter, at least 6 characters</span>
                            </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div>
                            <label for="User Roles" style="font-size: 16px; width: 200px"> User Roles DHIS2</label>
                        </div>
