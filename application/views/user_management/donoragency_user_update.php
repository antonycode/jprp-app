...
<section class="content">
    ...
    <div class="container">
        <div class="row">
            <form class="user_form" id="program_details" action="<?php echo base_url('user_manager/agencydonor_update/'.$userid)?>" method="post">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email"  value="<?php echo $user->email; ?>" 
                                       pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" maxlength="40" />
                            ...
                            <div class="form-group">
                                ...
                                <span class="form_hint">Kindly Select A Valid JPHES User Role</span>
                            </div>   
                            <?php
                            	if ($associate!=FALSE) {
									echo '
									...
									echo '
		                                ...
		                                <span class="form_hint">Kindly Select A Valid Associate Organization</span>									
									';
