...
<section class="content">
    ...
    <div class="container">
        <div class="row">
            <form class="user_form" id="program_details" action="<?php echo base_url('user_manager/'.$usercreatefunction)?>" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="firstname" id="firstname"  placeholder="First Name"  required pattern="[A-Za-z\s]{2,}" maxlength="20" />
                                <span class="form_hint">Must Be Of Atleast 2 Characters</span>
                            </div>

                            <div class="form-group">
                                <label for="name">Surname:</label>
                                <input type="text" name="surname" id="surname"  placeholder="Surname"  required pattern="[A-Za-z\s]{2,}" maxlength="20" />
                                <span class="form_hint">Must Be Of Atleast 2 Characters</span>
                            </div>
                            <div class="form-group">
