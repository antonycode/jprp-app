                ...
                <form class="donor_form" id="Mechanism_details" action="<?php echo base_url('mechanisms/update_mechanism')?>" method="post" style="margin-left: -30px ">
                    <ul>    
                        <li>
                        ...
                        <li>
                            ...
                            <input type="text" name="mechanism_name" id="" value="<?php echo $mechanism->mechanism_name; ?>"  placeholder="9171 - South Rift Valley"  required pattern="{10,}"  />
                            <span class="form_hint">Mechanism Name Must Be Of Atleast 10 Characters</span>
                        </li> 
                        <li>
                            <label for="name">Datim ID:</label>
                            <input type="text" name="datim_id" id="" readonly value="<?php echo $mechanism->datim_id; ?>"  placeholder="11243"   pattern="[1-9][0-9]{4,}"  />
                            <!-- <span class="form_hint">Mechanism ID Must Be Of Atleast 4 Integer Character Long</span> -->
                        </li>                         
                        <li>
                            <label for="name">Partner Name:</label>
                            <input type="text" name="partner_name" id="" value="<?php echo $mechanism->partner_name; ?>"   placeholder="South Rift Valley VCT"  required pattern="{10,}"  />
                            <span class="form_hint">Partner Name Must Be Of Atleast 10 Characters</span>
                        </li>                         
                        <li>
                            <label for="name">KePMS ID:</label>
                            <input type="text" name="kepms_id" id="" required value="<?php echo $mechanism->mechanism_id; ?>"  placeholder="124"  pattern="[1-9][0-9]{1,}"  />
                         ...
                         <li>
                            ...
                            <input type="text" name="start_date" id="start_date" value="<?php echo $mechanism->start_date; ?>"  required pattern="\d{1,2}-\d{1,2}-\d{4}"  placeholder="dd-mm-yyyy"    />
                           <span class="form_hint">Date format must be dd-mm-yyyy</span>
                        </li> 
                         <li>
                            <label for="name">Mechanism End Date:</label>
                            <input type="text" name="end_date" id="end_date" value="<?php echo $mechanism->end_date; ?>"  required pattern="\d{1,2}-\d{1,2}-\d{4}" placeholder="dd-mm-yyyy"    />
                            <span class="form_hint">Date format must be dd-mm-yyyy</span>
                        </li>                                                                                                                                                                                            
