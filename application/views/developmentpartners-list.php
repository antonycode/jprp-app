...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#">MOH</a></li>
        <li class="active">Development Partners List</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Development Partners List </h3>
                ...
                <?php if ($program_right) {
                    echo '<a href="' . base_url('moh_manager/adddevp') . '" class="btn btn-primary btn-sm" style="float: right; margin-right: 10%; margin-top: 0.2%; font-size: 14px; color: white">Add Development Partner</a>';
                } ?>
