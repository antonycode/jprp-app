...
<section class="content">
    ...
    <form class="donor_form" id="mechanism_details" action="<?php echo base_url('agency_mechanism/save_mechanism_update')?>" method="post" style="margin-left: -30px ">
        <ul>
            <li>
            ...
            <li>
                ...
                <input type="text" name="end_date" id="end_date" required pattern="\d{4}-\d{1,2}-\d{1,2}" value="<?php if(isset($mechanism->end_date)) echo $mechanism->end_date; ?>"  placeholder="yyyy-mm-dd"/>
                <span class="form_hint">Date format must be yyyy-mm-dd</span>
            </li>
            <li>
                <div>
